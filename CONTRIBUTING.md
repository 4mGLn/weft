...
Read `GOAL.md`, the relevant part of `DOMAIN.md`, and `AGENTS.md`. Material work should create or update a task record from `docs/agent-harness/task-template.md`.
